...
<div class="row heading-bg">
	<div class="col-xs-12">
		<h5 class="txt-dark">Ürün Düzenle</h5>
	</div>
</div>
							...
							<div  class="pills-struct">
								<ul role="tablist" class="nav nav-pills">
									<?php foreach(all_languages() as $item): ?>
										...
										<?php if($item->default == 1): ?><a href="<?php echo site_url('product/admin/index/'.@$page[$item->lang]['parent']); ?>" class="btn btn-xs btn-default pull-right" data-toggle="tooltip" title="Üst Sayfaya Git"><i class="fa fa-arrow-left"></i></a><?php endif; ?>
									<?php endforeach; ?>
								</ul>
											...
											<div class="row">											
												<div class="col-md-9 col-xs-12">
													...
													<div class="form-group">
														...
														<textarea class="form-control" id="<?php echo $item->lang ?>[summary]" name="<?php echo $item->lang ?>[summary]" rows="3"><?php echo @$page[$item->lang]['summary'] ?></textarea>
													</div>
													<div class="form-group">
													...
													<div class="col-md-3 col-xs-12">
														...
														<div class="form-group">
															...
															<input type="hidden" name="<?php echo $item->lang ?>[oldurl]" value="<?php echo @get_seo_url("product/index/".$page[$item->lang]['id']); ?>" />
															<input type="text" class="form-control" id="<?php echo $item->lang ?>[url]" name="<?php echo $item->lang ?>[url]" value="<?php echo @get_seo_url("product/index/".$page[$item->lang]['id']); ?>" />
														</div>
														<?php if(! @$page[$item->lang]['list_img'] == ""): ?>
															<div class="panel panel-default">
																<div class="panel-heading"><div class="panel-title">Görsel <small>(Listeleme)</small><a onclick="delete_confirm('<?php echo site_url('product/admin/delete_record_img/list_img/'.@$page[$item->lang]['id']); ?>')" class="btn btn-default btn-xs pull-right" data-toggle="tooltip" title="Sil"><i class="fa fa-trash" aria-hidden="true"></i></a></div></div>
																<img src="<?php echo $page[$item->lang]['list_img']; ?>" class="img-responsive" />
															</div>
														<?php endif; ?>
														<?php if(! @$page[$item->lang]['header_img'] == ""): ?>
															<div class="panel panel-default">
																<div class="panel-heading"><div class="panel-title">Görsel <small>(Üst)</small><a onclick="delete_confirm('<?php echo site_url('product/admin/delete_record_img/header_img/'.@$page[$item->lang]['id']); ?>')" class="btn btn-default btn-xs pull-right" data-toggle="tooltip" title="Sil"><i class="fa fa-trash" aria-hidden="true"></i></a></div></div>
														...
														<div id="sortable_<?php echo $item->lang ?>" class="row portf">
															<?php if(@$page[$item->lang]['gallery']): ?>
																<?php foreach($page[$item->lang]['gallery'] as $galleryItem): ?>
																	<div class="col-md-2 col-sm-6 col-xs-12" id="listItem_<?php echo $galleryItem->id; ?>">
																		<div class="row">
																			<div class="col-xs-6">
