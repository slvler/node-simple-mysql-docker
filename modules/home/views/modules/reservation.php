...
<section id="homeSearch" class="r-search home-search">
	<div class="container">
		<div class="r-search-head">
			<div class="r-search-head-tabs">
				<ul class="nav nav-tabs r-search-tabs" id="rSearchTab" role="tablist">
					<li class="nav-item">
						<a href="#tab1" class="nav-link r-tablink active" data-toggle="tab" role="tab"><?php echo lang_transform("reservation_form"); ?></a>
					</li>
					<li class="nav-item">
						<a href="#tab2" class="nav-link r-tablink" data-toggle="tab" role="tab"><?php echo lang_transform("packages_and_offers"); ?></a>
					</li>
				</ul>
			</div>
			<!-- <div class="r-search-head-ext">
				<a href="javascript:;" data-fancybox data-src="#modalReservationCode" class="r-tablink lnk-reservation-code"><span class="underline"><?php echo lang_transform("enter_reservation_code"); ?>?</span></a>
			</div> -->
		</div>
		<div class="r-search-body">
			<div class="tab-content r-search-tabcontent">
				<div class="tab-pane r-search-tabpane fade show active" id="tab1" role="tabpanel">
					<form action="<?php echo site_url("reservation"); ?>" method="post" id="formReservationSearch" class="r-search-form">
						...
						<div class="r-search-form-group r-search-dates">
							<label class="r-search-form-label">
								...
								<!-- <span><span class="r-search-day">3</span> Gün</span> -->
							</label>
							<input type="text" name="daterange" class="form-control r-search-form-input daterange" />
						</div>
						<div class="r-search-form-group r-search-guests">
							<label class="r-search-form-label">
								<span><?php echo lang_transform("rooms_and_visitors"); ?></span>
								<span class="text-danger js-r-search-guest-err"></span>
							</label>
							<a class="form-control custom-select r-search-form-input r-search-form-select collapsed" href=".js-r-rooms-guests-panel" data-toggle="collapse">
							...
							<div class="collapse r-rooms-guests-panel js-r-rooms-guests-panel">
				...
				<div class="tab-pane r-search-tabpane" id="tab2" role="tabpanel">
...
<div id="modalReservationCode" class="modal-r-code">
	<form action="javascript:;" method="post" class="r-modal-form" novalidate="novalidate">
		<p>
			<img src="upload/iconReservationCode.png" alt="">
		</p>
		<label class="form-label"><?php echo lang_transform("enter_reservation_code"); ?></label>
		<div class="input-group mb-3">
			<input type="text" class="form-control" placeholder="DNZX564345">
			<div class="input-group-append">
				<button class="btn btn-primary" type="button" id="button-addon2"><?php echo lang_transform("approve"); ?></button>
			</div>
		</div>
	</form>       
</div>