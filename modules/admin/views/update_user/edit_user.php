						...
						<div class="form-wrap">
							<form method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="user" name="user" value="<?php echo $page['user'] ?>" disabled />
								</div>
								<div class="form-group">
									<label class="control-label mb-10 text-left" for="password">Şifre</label>
									<input type="password" class="form-control" id="password" name="password" placeholder="Şifre" value="<?php echo $page['password'] ?>" required="required" />
								</div>
