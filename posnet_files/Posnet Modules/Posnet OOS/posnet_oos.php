<?php
	...
	/**
		...
		Function getMacFor3DSTransaction($Session){
            $mac ="";
            try{
                $mac = hashString($Session->xid . ";" . $Session->amount . ";" . $Session->currency . ";" . $Session->merchantNo . "; " . hashString( $this->merchantInfo->enckey . ";" . $Session->terminalNo));
            }catch (Exception $e){
                echo 'Message: '.$e->getMessage();
            }
			return $mac;
		...
		Function getMacFor3DSResponse($Session){
            ...
            $mac ="";
            try{
                $mac = hashString($Session->responseHostlogKey . ";" . $Session->xid . ";" + $Session->amount . ";"
                    . $Session->currency . "; " . $Session->merchantNo . ";"
                    . hashString($this->merchantInfo->enckey . ";" . $Session->terminalNo));
            }catch (Exception $e){
                echo 'Message : '.$e->getMessage();
            }
            return $mac;
